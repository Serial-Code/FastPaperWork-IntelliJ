...
@Service
public class ReportPqrsService {
    @Autowired
    ...
    public ReportPqrsDTO obtenerReportePqrs(Map<String, Object> params)
            throws JRException, IOException, SQLException {
        String fileName = "ReportePqrs";
        ReportPqrsDTO dto = new ReportPqrsDTO();
